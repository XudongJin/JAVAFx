...
public class Circle2D {
	...
	public Circle2D(double x, double y, double radius,Paint color) {
		super();
		this.x = x;
		this.y = y;
		this.radius = radius;
	...
	public boolean ntpp(Circle2D circle){
	...
	public boolean tpp(Circle2D circle){
		double distance = distance2centre(circle.getX(),circle.getY());
		if(distance==(radius-circle.getRadius()))
			return true;
		else 
	...
	public boolean ntppc(Circle2D circle){
		double distance = distance2centre(circle.getX(),circle.getY());
	...
	public boolean tppc(Circle2D circle){
		double distance = distance2centre(circle.getX(),circle.getY());
		if(distance==(circle.getRadius()-radius))
			return true;
		else 
	...
	public boolean po(Circle2D circle){
		double distance = distance2centre(circle.getX(),circle.getY());
		if(distance<(circle.getRadius()+radius)&&
	...
	public boolean ec(Circle2D circle){
		double distance = distance2centre(circle.getX(),circle.getY());
		if(distance==(circle.getRadius()+radius))
			return true;
		else 
